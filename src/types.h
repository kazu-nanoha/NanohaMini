...
#else
const int PLY_MAX_PLUS_2 = PLY_MAX + 4; // ���O�ƈ�v���Ȃ����A+4�ɂ���(+2���Ɣz��I�[�o�[����)�B
                                        // ���Ƃ�Version�ł͑O��2�A����2�T�C�Y���g�����Ă���̂őÓ��ȏ��u���ƁB
#endif
...
// �ȉ��̔���� x ����(EMP)���(WALL)�łȂ����Ƃ�v������(���ǂ̏ꍇ�͐���������ł��Ȃ�)
...
typedef uint8_t PieceKind_t;   // ����
typedef uint8_t PieceNumber_t; // ��ԍ�
...
/*
	...
	xxxxxxxx xxxxxxxx x111xxxx xxxxxxxx  �j
	xxxxxxxx xxxxx111 xxxxxxxx xxxxxxxx  ��
	xxxxxxxx x111xxxx xxxxxxxx xxxxxxxx  ��
	xxxxxx11 xxxxxxxx xxxxxxxx xxxxxxxx  �p
	xx11xxxx xxxxxxxx xxxxxxxx xxxxxxxx  ��
	���̂悤�ɒ�`�����16�i���ŕ\�������Ƃ��ɂǂ̋�����������Ă��邩�킩��₷���B
	��j��A���A�j���e1���A����8�������Ă���Ƃ��� 0x10101008 �ƂȂ�
 */
...
#define MAX_CHECKS 128  // ����̍ő吔
#define MAX_EVASION 128 // �������̍ő吔

namespace NanohaTbl
{
extern const short z2sq[];
extern const int Direction[];
extern const int KomaValue[32];    // ��̉��l
extern const int KomaValueEx[32];  // ���ꂽ�Ƃ�(�ߊl���ꂽ�Ƃ�)�̉��l
extern const int KomaValuePro[32]; // ���鉿�l
extern const int Piece2Index[32];  // ��̎�ނɕϊ�����({�ƁA�ǁA�\�A�S}�����Ɠ��ꎋ)
}

// �Ȃ̂͂̍��W�n(0x11�`0x99)��(0�`80)�Ɉ��k����
...
#define __assume(x) // MS �̃R���p�C���̃R�[�h�����̃q���g�����Agcc�ł͖����Ȃ���
...
// �o�͌n
int output_info(const char *fmt, ...);           // ���o��(printf()����)
int foutput_log(FILE *fp, const char *fmt, ...); // ���o��(printf()����)
// int output_debug(const char *fmt, ...);		// for �f�o�b�O

#define ENABLE_MYASSERT // MYASSERT()��L���ɂ���
#if defined(ENABLE_MYASSERT)
extern int debug_level;
// x ���^�̂Ƃ��ɉ������Ȃ�
// *static_cast<int*>(0)=0�Ń������ی��O���������A�������Ɏ~�܂邽�߃f�o�b�O���₷��.
#define MYASSERT(x)                                                         \
	do {                                                                    \
		if (!(x)) {                                                         \
